...
//    
    public func setPanelStatus(status:JKType) {
        switch (status) {
        case .SUCCESS:
            imageIcon.image = UIImage(named: "success-icon")
            textLabel.text = "Success"
            baseView.backgroundColor = originalDarkGrey//  UIColor(red: 35.0/255.0, green: 160.0/255.0, blue: 73.0/255.0, alpha: 1)
        case .WARNING:
            imageIcon.image = UIImage(named: "warning-icon")
            textLabel.text = "Warning"
            baseView.backgroundColor = UIColor(red: 249.0/255.0, green: 169.0/255.0, blue: 69.0/255.0, alpha: 1)
        case .FAILED:
            imageIcon.image = UIImage(named: "fail-icon")
